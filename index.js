            ...
            <form id="dish-form" class="p-4 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                    <div class="text-center">
                        ...
                        <img src="${dish.dishImage}" alt="${dish.dishName}" class="w-full h-48 object-cover rounded-md shadow-md"/>
                    </div>
                    <div class="text-center">
...
function renderCameraCapture(initialImage) {
    ...
    container.innerHTML = `
        <div id="camera-placeholder" class="w-full h-48 rounded-md shadow-md bg-gray-700 flex flex-col items-center justify-center text-gray-400 border-2 border-dashed border-gray-600 cursor-pointer hover:bg-gray-600">
        ...
        <div id="camera-view" class="w-full h-48 rounded-md shadow-md bg-black flex flex-col items-center justify-center hidden">
        ...
        <div id="image-preview" class="w-full h-48 rounded-md shadow-md relative group hidden">
